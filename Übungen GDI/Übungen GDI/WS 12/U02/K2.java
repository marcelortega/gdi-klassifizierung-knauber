...
public interface HangManGame {
	...
	/**
	 * Dieser Char repräsentiert einen nicht erratenen Buchstaben.
	 */
	public static final char HIDDEN_CHAR = '_';

	/**
	 * Das Spiel wird in den Startzustand gebracht. - neuen Begriff auswählen -
	 * Fehlversuche auf 0 setzen
	 */
	public void start();

	/**
	 * Fügt einen weiteren Buchstaben hinzu. Groß- oder Kleinbuchstabe soll egal
	...
	/**
	 * 
	 * @return true falls das Rätsel gelöst wurde.
	 */
	public boolean won();
