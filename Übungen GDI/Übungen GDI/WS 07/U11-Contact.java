...
public interface Contact {
	...
	/**
	 * Diese Methode ermöglicht das Setzen der Kategorie
	 * für einen Kontakt. Es sind nur existierende Kategorienamen
	 * erlaubt.
	 */
	...
	/**
	 * Diese Methode ermöglicht das Setzen eines Geburtsdatums.
	 * Es erfolgt keine Rückmeldung, ob es sich um ein gültiges
	 * Datum handelt; das kann mithilfe der Methoden 
	 * <code>getDayOfBirth</code>, 
	 * <code>getMonthOfBirth</code> oder
	 * <code>getYearOfBirth</code> überprüft werden.
	 */
	 ...
	 * gültiges Geburtsdatum eingetragen wurde, sonst einen
	 * leeren String.
	 */
	 ...
	 * genau dann, wenn zuvor ein gültiges Geburtsdatum 
	...
	/**
	 * Mittels dieser Methode lässt sich einstellen, ob im
	 ...
	 * "Hans Schmidt hat am nächsten Freitag Geburtstag" 
	 ...
	 * abhängig, ob der Reminder gesetzt wurde (Methode
